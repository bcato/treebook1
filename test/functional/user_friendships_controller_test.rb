...
class UserFriendshipsControllerTest < ActionController::TestCase
  context "#index" do
    ...
    context "when logged in" do
      setup do
        @friendship1 = create!(:pending_user_friendship, user: users(:brandon), friend: create(:user, first_name:'Pending', last_name: 'Friend'))
        @friendship2 = create!(:accepted_user_friendship, user: users(:brandon), friend: create(:user, first_name: 'Active', last_name: 'Friend'))
    ...
    should "display pending information on a pending friendship" do
      assert_select "#user_frienship_#{@friendship1.id}" do
  ...
  context "#new" do
  	...
  	context "when logged in" do
  	  ...
  	  should "assign a new user to the currently logged in user" do
  	  	get :new, friend_id: users(:jim)
  	  	assert_equal users(:brandon), assigns(:user_friendship).user
  	  end
